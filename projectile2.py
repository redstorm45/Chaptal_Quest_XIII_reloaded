...
<<<<<<< HEAD
        distance = ( (tireur.position[1]-(cibleposition[1]+(cible.hitbox[0] + cible.hitbox[1])/2 - 0.5))**2 + (tireur.position[2]-(cibleposition[2]+(cible.hitbox[2] + cible.hitbox[3])/2 - 0.5))**2 )**0.5
        if distance == 0:
            distance = 1/16
        self.unitX = (cibleposition[1] + (cible.hitbox[0] + cible.hitbox[1])/2 - tireur.position[1]-(tireur.hitbox[0] + tireur.hitbox[1])/2)/distance
        self.unitY = (cibleposition[2] + (cible.hitbox[2] + cible.hitbox[3])/2 - tireur.position[2]-(tireur.hitbox[2] + tireur.hitbox[3])/2)/distance
=======
...
>>>>>>> origin/master
        ...
        self.position = tireur.position[1] + (tireur.hitbox[0] + tireur.hitbox[1])/2 - 0.5 , tireur.position[2] + (tireur.hitbox[2] + tireur.hitbox[3])/2 - 0.5
        
        self.life = tireur.projectileLife
